...
| SECURITY    | successful RDSEED or RDRAND only | optional - 48 B hardware-backed seed, out-of-line + entropy_crc. Josh verifies it with `bbp_verify_blob()` before use; hardware RNG absence or failure emits no entropy tag. |
