...
| BBP v2 contiguous capsule Draft | 🟢 HOST-TESTED / MULTI-ISA COMPILED | offline-only parser, failure-atomic deterministic builder, canonical digest, v1.1 bridge, fuzzing, native Profile 0, and C/Rust/host package surfaces; Waves 26-27 close control-alias/stale-view gaps and add a generated 46-case C/Rust/Python repository corpus, while profile identity, critical entries, registries, auth, deployment, and freeze remain unresolved |
